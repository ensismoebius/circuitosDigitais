...
\begin{frame}
	...
	\begin{figure}
		\centering
		\input{images/circuitoAndOr.tex}
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{0.5\textwidth}
			\begin{figure}
				\centering
				\input{images/cicuitoXORAbstrato}
				\caption{Porta XOR}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			\centering
			\input{images/cicuitoNORAbstrato.tex}
			\caption{Porta NOR}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			\centering
			\input{images/cicuitoNANDAbstrato.tex}
			\caption{Porta NAND}
...
\begin{frame}
	...
	\par Dada a expressão lógica \( f = a \cdot \overline{b} \), desenhe o circuito combinacional correspondente. % f=a*~b
	\pause
	\begin{figure}
		\centering
		\input{images/exe10}
...
\begin{frame}
	...
	\par Dada a expressão lógica \( f = a \cdot b + \overline{a} \cdot \overline{b} \), construa a tabela verdade correspondente. %f=a*b+~a*~b
	\pause
	\par Tabela verdade: \\
	\begin{tabular}{cc|c}
		$a$&$b$&$f$\\
...
\begin{frame}
	...
	\par Dada a expressão lógica \( f = (a \cdot b + \overline{c}) \cdot (a + c) \), desenhe o circuito combinacional correspondente. %f=(a.b+~c).(a+c)
	\pause
	\begin{figure}
		\centering
		\input{images/exe12}
...
\begin{frame}
	...
	\par Dada a expressão lógica \( f = a + b \cdot \overline{c} \), desenhe o circuito combinacional correspondente. %f=a+b*~c
	\pause
	\begin{figure}
		\centering
		\input{images/exe13}
