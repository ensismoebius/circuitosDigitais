...
\fancyhead{}
\fancyhead[C] {Logisim-evolução gerada pelo documento em Mon Aug 12 11:24:04 BRT 2024}
\fancyfoot[C] {\thepage}
...
\karnaughmap{3}{$f$}{{$y$}{$x$}{$z$}}{}{
\draw[kmbox] (-0.5,2.5)
   node[below left]{$x$}
   node[above right]{$y$, $z$} +(-0.2,0.2)
   node[above left]{$f$};\draw (0,2) -- (-0.7,2.7);
\foreach \x/\1 in %
{0/00,1/01,2/11,3/10} {
   \node at (\x+0.5,2.2) {\1};
}
...
{0/0,1/1} {
   ...
   \node[grp={LogisimKMapColor1}{1.8}{0.8}](n0) at(3,1.5) {};
   \node[grp={LogisimKMapColor2}{0.8}{0.8}](n1) at(1.5,0.5) {};
}
\end{tikzpicture}
\end{center}
%===============================================================================
\section{Expressões mínimas}
$f =  \overline{x}  \cdot y+x \cdot  \overline{y}  \cdot z$~\\
\end{document}
