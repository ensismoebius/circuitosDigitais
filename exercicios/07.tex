...
\fancyhead{}
\fancyhead[C] {Logisim-evolução gerada pelo documento em Mon Aug 12 10:32:44 BRT 2024}
\fancyfoot[C] {\thepage}
...
\draw[kmbox] (-0.5,2.5)
   ...
   node[above left]{$x$};\draw (0,2) -- (-0.7,2.7);
\foreach \x/\1 in %
{0/0,1/1} {
   \node at (\x+0.5,2.2) {\1};
}
...
{0/0,1/1} {
   ...
   \node[grp={LogisimKMapColor2}{0.8}{1.8}](n1) at(0.5,1) {};
}
\end{tikzpicture}
\end{center}
%===============================================================================
